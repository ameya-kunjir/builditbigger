...
import com.example.android.jokedislib.JokeDisplayActivity;
...
public class MainActivity extends AppCompatActivity implements EndpointsAsyncTask.AsyncResponse {
    ...
    public void returnResponse(String output) {
        Intent displayJokeIntent = new Intent(this, JokeDisplayActivity.class).putExtra(Intent.EXTRA_TEXT, output);
